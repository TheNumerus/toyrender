...
impl TonemapPass {
    ...
    pub fn record(&self, command_buffer: &CommandBuffer, renderer: &VulkanRenderer) -> Result<(), VulkanError> {
        let attachments = [vk::RenderingAttachmentInfo {
            image_view: renderer.postprocess_render_target.view.inner,
        ...
        unsafe {
            self.device.inner.cmd_pipeline_barrier(
                ...
                &[vk::ImageMemoryBarrier {
                    ...
                    image: renderer.postprocess_render_target.image.inner,
        ...
        unsafe {
            ...
            self.device.inner.cmd_bind_descriptor_sets(
                ...
                pipeline.layout,
                1,
                &[renderer.descriptors.post_process_set.inner.inner],
                &[],
            );
